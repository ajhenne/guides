...
1.  [LINC](#orgb9a2a84)
    1.  [Installation](#orga35811d)
    2.  [Downloading data](#org2e10d70)
        1.  [Preparing data](#orgb5a7d9a)
    3.  [Running](#org4ca693a)
        1.  [Running LINC pipeline](#org9dcfc24)
        2.  [Debugging](#orgf1d43c4)
    4.  [Scripts](#org9aa926a)
    5.  [Possible issues](#orgb382dee)
        1.  [A different wrong download URL?](#org9c32ea3)
        2.  [Failing on `target/structure_function`](#org0414b56)
        3.  [OSError: [Errno 30] Read-only file system](#orgb765cf1)
2.  [WSClean](#org22fecf6)
    1.  [Basic Imaging Command](#org7cbd06b)
    2.  [Timeslicing](#org93f09ce)
    3.  [Additional commands](#orgf34ee19)
    4.  [msoverview](#orgd092932)
    5.  [Subtraction Imaging](#orgba09218)
3.  [Struis](#orgda153fd)
4.  [TRAP](#orgeec8eeb)
    1.  [Installation &#x2013; for tkp4.0 / python2.7 version](#org9fa8e9c)
        1.  [change commands to conda create env commands](#org02a3cec)
    2.  [Setting up TRAP](#orgb536b09)
        1.  [TKP PostgreSQL Login Details](#org651383b)
    3.  [Using TRAP](#orgd72f17a)
5.  [PostgreSQL](#org4042e37)
    1.  [Deleting databases](#orgf227e87)
6.  [Banana](#orgc6f2195)
...
Just things that came up as potential issues for me. These may just be user error, specific problems with the datasets, or things that have since been fixed by ASTRON. Most common error will be the `structure_function` issue as a result of poor quality data.
...
First create the subtracted data column during a run of WSClean, run as normal with the addition of:
`-update-model-required`

Then run the following python script to subtract the model from data. The only requirement is to have python-casacore installed via pip in your virtual environment.
